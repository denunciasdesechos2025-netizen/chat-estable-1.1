...
const VENICE_API_KEY = 'TU_API_KEY'; // Reemplaza con tu clave de API de Venice
        ...
        const response = await fetch(VENICE_API_URL, {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'Eres un asistente de la Alcaldía de San Salvador Este que ayuda a los ciudadanos con sus denuncias. Responde de manera amable y profesional en español.'
                    },
